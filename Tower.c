...
void Display(void)
{
	if (df == 10)
	{
		...
		glLoadIdentity();
		glColor3f(1.0, 0.0, 0.0);
		drawBitmapString(-5.0, 32.0, -60.0, GLUT_BITMAP_9_BY_15, "SJB INSTUTUION OF TECHNOLOLGY");
		drawBitmapString(-5.0, 29.0, -60.0, GLUT_BITMAP_9_BY_15, "DEPARTMENT OF COMPPUTER SCIENCE");
		drawBitmapString(-4.0, 25.0, -60.0, GLUT_BITMAP_9_BY_15, "A MINI PROJECT ON");
		drawBitmapString(-5.0, 23.0, -60.0, GLUT_BITMAP_9_BY_15, "TOWER OF HONIE");
		drawBitmapString(-4.0, 20.0, -60.0, GLUT_BITMAP_9_BY_15, "BY");
		drawBitmapString(-5.0, 18.0, -60.0, GLUT_BITMAP_9_BY_15, "CHETHAN  AND DEVI SHARAVYA ");
		drawBitmapString(-5.0, 16.0, -60.0, GLUT_BITMAP_9_BY_15, "UNDER THE GUIDENCE OF ");
		drawBitmapString(-3.0, 14.0, -60.0, GLUT_BITMAP_9_BY_15, "BINDYA M K");
		drawBitmapString(-4.0, 12.0, -60.0, GLUT_BITMAP_9_BY_15, "ASSOCIATE PROFESSOR ");
		drawBitmapString(-3.0, 10.0, -60.0, GLUT_BITMAP_9_BY_15, "DEPARTMENT OF CSE");
		drawBitmapString(-3.0, 8.0, -60.0, GLUT_BITMAP_9_BY_15, "PRAKRUTHI M K");
		drawBitmapString(-4.0, 6.0, -60.0, GLUT_BITMAP_9_BY_15, "ASSISTANT PROFESSOR");
		drawBitmapString(-3.0, 4.0, -60.0, GLUT_BITMAP_9_BY_15, "DEPARTMENT OF CSE");
